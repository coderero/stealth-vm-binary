...
static bool scsi_target_emulate_inquiry(SCSITargetReq *r)
{
    ...
    else
    {
        ...
        memcpy(&r->buf[16], "Samsung SSD 860 EVO     ", 16);
                            ...
                            uint32_t tag, uint32_t lun, void *hba_private)
{
    ...
    const int memset_off = offsetof(SCSIRequest, sense) + sizeof(req->sense);
...
static void scsi_cmd_xfer_mode(SCSICommand *cmd)
{
    ...
    case ATA_PASSTHROUGH_16:
        /* T_DIR */
        cmd->mode = (cmd->buf[2] & 0x8) ? SCSI_XFER_FROM_DEV : SCSI_XFER_TO_DEV;
        break;
    default:
...
const VMStateDescription vmstate_scsi_device = {
    ...
    .fields = (const VMStateField[]){
        ...
        VMSTATE_END_OF_LIST()},
    .subsections = (const VMStateDescription *const[]){&vmstate_scsi_sense_state, NULL}};
