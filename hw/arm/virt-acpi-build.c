...
build_iort(GArray *table_data, BIOSLinker *linker, VirtMachineState *vms)
{
    ...
    AcpiTable table = {.sig = "IORT", .rev = 3, .oem_id = vms->oem_id, .oem_table_id = vms->oem_table_id};
    /* Table 2 The IORT */
...
build_srat(GArray *table_data, BIOSLinker *linker, VirtMachineState *vms)
{
    ...
    AcpiTable table = {.sig = "SRAT", .rev = 3, .oem_id = vms->oem_id, .oem_table_id = vms->oem_table_id};
...
build_gtdt(GArray *table_data, BIOSLinker *linker, VirtMachineState *vms)
{
    ...
    AcpiTable table = {.sig = "GTDT", .rev = 3, .oem_id = vms->oem_id, .oem_table_id = vms->oem_table_id};
    ...
    build_append_int_noprefix(table_data, irqflags | 1UL << 2, /* Always-on Capability */
                              4);
    /* Virtual timer GSIV */
...
{
    AcpiTable table = {.sig = "DBG2", .rev = 0, .oem_id = vms->oem_id, .oem_table_id = vms->oem_table_id};
...
build_madt(GArray *table_data, BIOSLinker *linker, VirtMachineState *vms)
{
    ...
    AcpiTable table = {.sig = "APIC", .rev = 4, .oem_id = vms->oem_id, .oem_table_id = vms->oem_table_id};
    ...
    for (i = 0; i < MACHINE(vms)->smp.cpus; i++)
    {
        ...
        uint32_t pmu_interrupt = arm_feature(&armcpu->env, ARM_FEATURE_PMU) ? VIRTUAL_PMU_IRQ : 0;
...
build_dsdt(GArray *table_data, BIOSLinker *linker, VirtMachineState *vms)
{
    ...
    AcpiTable table = {.sig = "DSDT", .rev = 2, .oem_id = vms->oem_id, .oem_table_id = vms->oem_table_id};
...
static void virt_acpi_build(VirtMachineState *vms, AcpiBuildTables *tables)
{
    VirtMachineClass *vmc = VIRT_MACHINE_GET_CLASS(vms);
