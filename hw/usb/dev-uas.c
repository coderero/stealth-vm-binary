...
struct UASDevice
{
    ...
    SCSIBus bus;
    QEMUBH *status_bh;
    QTAILQ_HEAD(, UASStatus)
    results;
    QTAILQ_HEAD(, UASRequest)
    requests;
...
static const USBDescStrings desc_strings = {
    [STR_MANUFACTURER] = "ASMedia",
    [STR_PRODUCT] = "ASM1051 USB3.0 to SATA Bridge",
    [STR_SERIALNUMBER] = "USB3S2SAT3CB", // realistic alphanumeric serial
    [STR_CONFIG_HIGH] = "USB Mass Storage High-Speed",
    [STR_CONFIG_SUPER] = "USB Mass Storage SuperSpeed",
    ...
    .eps = (USBDescEndpoint[]){
        ...
        },
        {
            ...
            .extra = (uint8_t[]){
                0x04,                     /*  u8  bLength */
                0x24,                     /*  u8  bDescriptorType */
                UAS_PIPE_ID_STATUS, 0x00, /*  u8  bReserved */
            },
        },
        {
            ...
            .extra = (uint8_t[]){
                0x04,                      /*  u8  bLength */
                0x24,                      /*  u8  bDescriptorType */
                UAS_PIPE_ID_DATA_IN, 0x00, /*  u8  bReserved */
            },
        },
        {
            ...
            .extra = (uint8_t[]){
                0x04,                       /*  u8  bLength */
                0x24,                       /*  u8  bDescriptorType */
                UAS_PIPE_ID_DATA_OUT, 0x00, /*  u8  bReserved */
            },
        },
    }};
...
{
    USBPacket *p = uas_using_streams(uas) ? uas->status3[st->stream] : uas->status2;
