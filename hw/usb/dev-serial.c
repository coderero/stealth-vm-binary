...
static const USBDescStrings desc_strings = {
    [STR_MANUFACTURER] = "FTDI",
    [STR_PRODUCT_SERIAL] = "FT232 USB UART",
    [STR_PRODUCT_BRAILLE] = "BAUM VarioUltra 20",
    [STR_SERIALNUMBER] = "FTDI987654",
};
                                      ...
                                      int length, uint8_t *data)
{
    ...
    case VendorDeviceOutRequest | FTDI_SET_BAUD:
    {
        ...
        int subdivisor8 = subdivisors8[((value & 0xc000) >> 14) | ((index & 1) << 2)];
