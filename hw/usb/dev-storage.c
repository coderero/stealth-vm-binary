...
static const USBDescStrings desc_strings = {
    [STR_MANUFACTURER] = "Seagate",
    [STR_PRODUCT] = "Expansion Portable",
    [STR_SERIALNUMBER] = "NA7DK54D", // realistic style
    [STR_CONFIG_FULL] = "Full Speed Configuration",
    [STR_CONFIG_HIGH] = "USB 2.0 High-Speed Configuration",
    [STR_CONFIG_SUPER] = "USB 3.0 SuperSpeed Configuration",
