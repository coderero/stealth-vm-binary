...
#define VIRTIO_ID_NAME_KEYBOARD "Logitech USB Keyboard"
#define VIRTIO_ID_NAME_MOUSE "Logitech USB Optical Mouse"
#define VIRTIO_ID_NAME_TABLET "Wacom ISD-V4"
#define VIRTIO_ID_NAME_MULTITOUCH "Microsoft Surface MultiTouch"
...
static struct virtio_input_config virtio_mouse_config_v2[] = {
    ...
    },
    {
        ...
        .subsel = EV_REL,
        .size = 2,
        .u.bitmap = {(1 << REL_X) | (1 << REL_Y), (1 << (REL_WHEEL - 8))},
    },
    {/* end of list */},
};
