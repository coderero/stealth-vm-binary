...
#define CR4_RESERVED_MASK \
    (~(target_ulong)(CR4_VME_MASK | CR4_PVI_MASK | CR4_TSD_MASK | CR4_DE_MASK | CR4_PSE_MASK | CR4_PAE_MASK | CR4_MCE_MASK | CR4_PGE_MASK | CR4_PCE_MASK | CR4_OSFXSR_MASK | CR4_OSXMMEXCPT_MASK | CR4_UMIP_MASK | CR4_LA57_MASK | CR4_FSGSBASE_MASK | CR4_PCIDE_MASK | CR4_OSXSAVE_MASK | CR4_SMEP_MASK | CR4_SMAP_MASK | CR4_PKE_MASK | CR4_PKS_MASK | CR4_LAM_SUP_MASK | CR4_FRED_MASK))
...
#define MSR_IA32_APICBASE_RESERVED \
    (~(uint64_t)(MSR_IA32_APICBASE_BSP | MSR_IA32_APICBASE_ENABLE | MSR_IA32_APICBASE_EXTD | MSR_IA32_APICBASE_BASE))
...
#define MSR_EFER_RESERVED \
    (~(target_ulong)(MSR_EFER_SCE | MSR_EFER_LME | MSR_EFER_LMA | MSR_EFER_NXE | MSR_EFER_SVME | MSR_EFER_FFXSR))
...
#ifdef TARGET_X86_64
#define TARGET_DEFAULT_CPU_TYPE X86_CPU_TYPE_NAME("amd64")
#else
#define TARGET_DEFAULT_CPU_TYPE X86_CPU_TYPE_NAME("amd64")
#endif
